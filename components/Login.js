...
class Login extends React.Component {
    ...
    render() {
        if (this.props.home) {
            return (
                <Chat {...this.props} handleExit={this.handleExit} home={this.state.home} userInfo={this.state.userInfo} notification={this.state.notification} handleLogin={this.handleLogin} />
            )
        } else {
            return (
